...
CMPProcess <- function(counts, s=1) {
  if (s == 1) {
    CMPProc(counts)
  }
  else {
...
dSCMP <- function(NuOfVar,Lambda,Nu,count)
  ...
  # This is strictly a helper function designed to be called by the SCMPProc command
{
